...
/* .main-banner .item-1 {
  background-image: url(../src/assets/images/banner-01.jpg);
}

.main-banner .item-2 {
  background-image: url(../src/assets/images/banner-02.jpg);
}

.main-banner .item-3 {
  background-image: url(../src/assets/images/banner-03.jpg);
} */
...
.video {
  background-image: url(../src/assets/images/video-bg.jpg);
  background-repeat: no-repeat;
  background-size: cover;
  background-position: center center;
...
.page-heading {
  ...
  background-image: url(../src/assets/images/page-heading-bg.jpg);
